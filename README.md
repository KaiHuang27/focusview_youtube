...
- Scroll to zoom videos from `100%` to `500%` around the mouse pointer, with each nonzero wheel or trackpad input animating at least one percent unless the zoom limit is reached.
