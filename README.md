...
- Zoom slider drag uses a custom mouse-controlled slider with a wider hit area around the track and keeps tracking movement at the document level until release: after pressing that area, keep holding and move horizontally to adjust zoom even if the cursor is no longer directly above the thin track.
