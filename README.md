...
6. Click the FocusView toolbar button and confirm the popup opens with the FocusView name, concise YouTube tagline, zoom mode shortcut hint, secondary App Store rating text link, and feedback link.
...
6. Click the Safari toolbar FocusView button and confirm the popup responds with the FocusView name, concise YouTube tagline, zoom mode shortcut hint, secondary App Store rating text link, and feedback link.
