...
6. Click the FocusView toolbar button and confirm the popup opens with the FocusView name, concise YouTube tagline, zoom mode shortcut hint, Apple-style App Store rating CTA, and feedback link.
...
6. Click the Safari toolbar FocusView button and confirm the popup responds with the FocusView name, concise YouTube tagline, zoom mode shortcut hint, Apple-style App Store rating CTA, and feedback link.
