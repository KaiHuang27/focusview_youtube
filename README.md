...
- Scroll to zoom videos from `100%` to `500%` around the mouse pointer, with zoom speed following the wheel or trackpad delta and capped per event to avoid large jumps.
