...
- Wheel input accumulates into one frame-rate-independent animation, preserving precise internal trackpad deltas while displaying a clear integer percentage.
