...
- Reduced the maximum zoom change from a single wheel event to about ten percent.
- Animated wheel zoom in one-percent steps instead of jumping directly to the next target zoom.
