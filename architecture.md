...
- `src/review-prompt-state.test.js` verifies the first-activation threshold, legacy threshold and page-storage migration, serialized updates, unavailable-storage fallback, immediate counting, snooze behavior, terminal states, invalid storage recovery, and Chrome/Safari parity.
