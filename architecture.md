...
- `src/transform-state.test.js` verifies transform state behavior, Zoom mode gesture guards, drag-start hold cancellation, and drag-time playback-rate restoration with Node's built-in test runner.
