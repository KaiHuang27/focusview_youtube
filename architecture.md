...
- `src/review-prompt-state.js` contains the permission-free review counter state machine: two-activation threshold, migration from the former ten-activation threshold, immediate Zoom mode counting, five-use snooze, persisted-state validation, and terminal rated or dismissed states.
...
- `src/review-prompt-state.test.js` verifies the two-activation threshold, legacy threshold migration, immediate counting, snooze behavior, terminal states, invalid storage recovery, and Chrome/Safari parity.
