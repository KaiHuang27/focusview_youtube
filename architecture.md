...
- Confirm clicking the zoom button opens and closes the YouTube-style transform menu with gray rounded panel, compact top zoom control, red top-right Reset action, text rows, and right-aligned controls that stay inside the panel.
