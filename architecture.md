...
- The Safari extension manifest mirrors the Chrome manifest version and content script configuration, with a Safari toolbar popup so clicking the extension button always produces visible UI.
